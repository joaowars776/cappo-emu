...
/* 10:   */ 
/* 11:   */ public class UserStepsOffItemTrigger
...
/* 45:   */     {
/* 46:41 */       List<WiredTriggerBase> triggerList = (List)this.wiredManager.triggersWalksOffFurni.get(Integer.valueOf(Tile.xy));
/* 47:42 */       if (triggerList == null)
/* 48:   */       {
/* 49:43 */         triggerList = new ArrayList();
/* 50:44 */         this.wiredManager.triggersWalksOffFurni.put(Integer.valueOf(Tile.xy), triggerList);
/* 51:   */       }
/* 52:46 */       if (triggerList.isEmpty()) {
/* 53:47 */         item.eventSetFlag(Tile.xy, 512, true);
/* 54:   */       }
...
/* 80:   */     {
/* 81:73 */       List<WiredTriggerBase> triggerList = (List)this.wiredManager.triggersWalksOffFurni.get(Integer.valueOf(Tile.xy));
/* 82:74 */       if (triggerList != null)
/* 83:   */       {
/* 84:75 */         triggerList.remove(this);
/* 85:76 */         if (triggerList.isEmpty())
/* 86:   */         {
/* 87:77 */           this.wiredManager.triggersWalksOffFurni.remove(Integer.valueOf(Tile.xy));
/* 88:78 */           item.eventSetFlag(Tile.xy, 512, false);
/* 89:   */         }
/* 90:   */       }
/* 91:   */     }
/* 92:   */   }
